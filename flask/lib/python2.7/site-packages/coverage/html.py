...
class HtmlReporter(Reporter):
    ...
    def index_file(self):
        """Write the add_conference.html file for this report."""
        index_tmpl = Templite(read_data("add_conference.html"), self.template_globals)
        ...
        write_html(os.path.join(self.directory, "add_conference.html"), html)
...
class HtmlStatus(object):
    ...
    def index_info(self, fname):
        """Get the information for add_conference.html for `fname`."""
        return self.files.get(fname, {}).get('index', {})

    def set_index_info(self, fname, info):
        """Set the information for add_conference.html for `fname`."""
